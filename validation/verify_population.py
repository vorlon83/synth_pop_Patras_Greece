...
# Expected total people for the Patras file.
# Change to None to skip the absolute count assertion (e.g. for full-Achaia file).
EXPECTED_TOTAL = 215929
...
if EXPECTED_TOTAL is not None:
    if len(members) == EXPECTED_TOTAL:
        ...
        msg = f'Total people {len(members):,} != expected {EXPECTED_TOTAL:,}'
