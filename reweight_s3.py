...
TEMPLATE_PATH = os.path.join(ROOT, 'Thesis_Synthpop-main', 'it_microdata_preprocess', 'household_compositions.json')
OUT_PATH      = os.path.join(ROOT, 'Thesis_Synthpop-main', 'it_microdata_preprocess', 'household_compositions_s3.json')
