...
- SHA-256: `48e4053c0ecd6daf5908c0e2eb5a764402d4b247c034e0157e54491551ded9ab` (canonical, education-reweighted to Patras B02; the earlier `d47d9df2…` hash was the pre-reweight file)
...
- [x] Run `pipeline.ipynb` end-to-end → `initial_state.geojson`, `schools.geojson`
  - Or run `python gis/assignment.py` standalone (now seeded via `PIPELINE_SEED`, default 42)
  - GIS numbers: 182,179/215,927 assigned (84.4%), median |Δ|=0.6%, 43/55 districts within ±10%
- [x] Run `build_agents.py` → `agents_patras.csv` (215,927 rows)
